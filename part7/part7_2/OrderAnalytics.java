...
public class OrderAnalytics {
    ...
    public static void main(String[] args) {
        ...
        // ▼ ВАШ КОД ЗДЕСЬ ▼
        var avgByClient = orders.stream()
                .collect(Collectors.groupingBy(Order::customer, Collectors.averagingDouble(Order::total)));
